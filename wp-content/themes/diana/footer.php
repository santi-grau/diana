        ...
        <div class="modal contact-box" id="contactModal" onclick="closeModal()">
            <div class="box">
                ...
                <ul class="social-icons">
                    <li><a class="social fb" href="javascript:void(0)"></a></li>
                    <li><a class="social tw" href="javascript:void(0)"></a></li>
                    <li><a class="social vimeo" href="javascript:void(0)"></a></li>
                    <li><a class="social ig" href="javascript:void(0)"></a></li>
                </ul>
            </div>
        </div>
